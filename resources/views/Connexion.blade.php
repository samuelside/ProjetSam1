    ...
    <div class="formulaire">
		<form action="{{ route('post.AuthPart') }}" method='post'>
			...
			<div class="form-group">
				...
				<input type="Email" class="form-control" id="emailParticipant" name='emailParticipant'
					aria-describedby="emailHelp" placeholder="Enter email">
				<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
			</div>
			<div class="form-group">
				<label for="exampleInputPassword1">Password</label>
				<input type="Password" class="form-control" id="passwordParticipant" name='passwordParticipant'
			...
			<button type="submit" class="btn" id="boutonSoumettre">Se connecter </button>
		</form>
	</div>
